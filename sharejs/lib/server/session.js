    ...
    case 'qsub':
      ...
      agent.query(index, req.q, qopts, function(err, emitter) {
        ...
        function cleanupQuery() {
          ...
          // Remove the listeners attached below. This assumes that nobody else
          // attaches listeners to the event (or that nothing lives beyond
          // destroy()), which might be dangerous at some point.
